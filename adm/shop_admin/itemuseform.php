...
$sql = " select *
		   ...
		   left join g5_write_dental c on (a.it_id = c.wr_code)
          where is_id = '$is_id' ";
$is = sql_fetch($sql);
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row">병원명</th>
        <td><a href="<?php echo get_pretty_url('dental', $is['wr_id']).'&den_id='.$is['wr_code']; ?>"><?php echo $is['wr_subject']; ?></a></td>
    </tr>
    <tr>
        <th scope="row">이름</th>
        <td><?php echo $name; ?></td>
    ...
    <tr>
        <th scope="row">삭제 요청 여부</th>
        <td><?php echo $is['is_delete'] == 1 ? '<b style="color:red">삭제 요청</b>' : '' ?></td>
    </tr>
    <tr>
        <th scope="row">삭제 사유</th>
        <td><?php echo conv_content($is['is_delete_content'], 0)?></td>
    </tr>
    <tr>
        <th scope="row">확인</th>
        <td>
