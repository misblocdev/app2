...
$pg_anchor = '<ul class="anchor">
    ...
    <li style="display: none;"><a href="#anc_cf_extra">여분필드</a></li>
</ul>';
...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="cf_7">포인트 채굴 기본지급</label></th>
            <td colspan="3"><input type="number" name="cf_7" value="<?php echo $config['cf_7']; ?>" id="cf_7" class="frm_input" size="40" min="0"></td>
        </tr>
        <tr>
...
<section id="anc_cf_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="cf_1">제3자 정보 제공 동의</label></th>
            <td colspan="3"><textarea id="cf_1" name="cf_1" rows="10"><?php echo html_purifier($config['cf_1']); ?></textarea></td>
        </tr>
        </tbody>
        </table>
    </div>
