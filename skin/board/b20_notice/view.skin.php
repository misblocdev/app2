...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
		...
		<strong class="if_date"><span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date("Y-m-d", strtotime($view['wr_datetime'])) ?></strong>
    ...
    <!-- 게시물 상단 버튼 시작 { -->
    <div id="bo_v_top" class="btn_wrap">
        <?php
        ob_start();
        ?>
		<?php
		if(!$prev_href) {
			$prev_href = "javascript:alert('이전글이 존재하지 않습니다.');";
		}
		if(!$next_href) {
			$next_href = "javascript:alert('다음글이 존재하지 않습니다.');";
		}
		?>
		<ul>
			<?php if ($prev_href) { ?><li><a href="<?php echo $prev_href ?>" class="btn_b03 btn">이전</a></li><?php } ?>
			<?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b03 btn">수정</a></li><?php } ?>
            
            <!-- <?php if ($copy_href) { ?><li><a href="<?php echo $copy_href ?>" class="btn_b03 btn" onclick="board_move(this.href); return false;"><i class="fa fa-files-o" aria-hidden="true"></i> 복사</a></li><?php } ?>
            <?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" class="btn_b03 btn" onclick="board_move(this.href); return false;"><i class="fa fa-arrows" aria-hidden="true"></i> 이동</a></li><?php } ?>
            <?php if ($search_href) { ?><li><a href="<?php echo $search_href ?>" class="btn_b03 btn"><i class="fa fa-search" aria-hidden="true"></i> 검색</a></li><?php } ?> -->			
            ...
            <!-- <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b03 btn">글쓰기</a></li><?php } ?> -->
			<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b03 btn" onclick="del(this.href); return false;">삭제</a></li><?php } ?>
			<?php if ($next_href) { ?><li><a href="<?php echo $next_href ?>" class="btn_b03 btn">다음</a></li><?php } ?>
		</ul>
        <?php
