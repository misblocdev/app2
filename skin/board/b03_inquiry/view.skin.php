...
@media (max-width: 800px) {
	...
	.jtbl_frm01 th{width:25%; font-size: 18px; padding-left: 10px; height:50px;}
}
</style>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_con">		
			<div class="jtbl_frm01 tbl_wrap" style="margin-bottom: 0;">
				...
				<!-- <tr>
					<th scope="row"><label for="wr_2">산업구분</label></th>
					<td>
						<?php echo $view['wr_2'] ?>
					</td>
				</tr> -->
				...
				<!-- <tr>
					<th scope="row"><label for="wr_3">이름/직급</label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="wr_5">부서/팀명</label></th>
					<td>
				...
				<tr>
					<th scope="row"><label for="wr_7">직무</label></th>
					<td class="td_job">
						<?php echo $view['wr_7'] ?>
					</td>
				</tr> -->
				...
				<tr>
					<th scope="row"><label for="wr_8">전화번호</label></th>
					<td>
						<?php echo $view['wr_8'] ?>
					</td>
				</tr>
				...
				<tr>
					<th scope="row"><label for="wr_9">휴대폰번호</label></th>
					<td>
						<?php echo $view['wr_9'] ?>
					</td>
				</tr>        
				...
				<tr>
					<th scope="row"><label for="wr_content">진료 및 <br>문의내용</label></th>
					<td>
				...
				<!-- <tr>
					<th scope="row"><label for="wr_link<?php echo $i ?>">인지경로</label></th>
					<td>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
			...
			?>
           <?php if($is_admin || $member['mb_id'] == $view['wr_10'])?><li><a href="<?php echo $list_href ?>" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
