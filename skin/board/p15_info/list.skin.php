...
$row_ca = sql_fetch(' select * from g5_board where bo_table = "'.$bo_table.'" ');
$catelist = explode('|', $row_ca['bo_category_list']);
if(!$sca) goto_url(G5_BBS_URL.'/board.php?bo_table='.$bo_table.'&sca='.$catelist[0]);
...
#bo_cate li:nth-child(n+6) {margin-bottom: 0;}
...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <fieldset id="bo_sch" style="display: none;">
        ...
        <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="sch_input" size="20" maxlength="20" placeholder="검색어를 입력해주세요">
                ...
                <div class="gall_con clearfix">
                    ...
                    <div class="gall_text_href">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                            <strong><?php echo $list[$i]['ca_name'] ?></strong> <span>|</span> <?php echo $list[$i]['subject'] ?>
					...
					<div class="gall_btn">
						<a href="<?php echo $list[$i]['href'] ?>"><img src="/images/btn_info.png" alt="상세보기"></a>
					</div>
                </div>
            </div>
        </li>
        <?php } ?>
        <?php if (count($list) == 0) { echo "<li class=\"empty_list\">등록된 지식정보가 없습니다.</li>"; } ?>
    </ul>
    ...
    <div class="bo_fx">
        <?php if ($is_checkbox) { ?>
        <ul class="btn_bo_adm">
			<li><span class="jbutton large black"><button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value"><i class="fa fa-trash-o" aria-hidden="true"></i> 선택삭제</button></span></li>
			<li><span class="jbutton large black"><button type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value"><i class="fa fa-files-o" aria-hidden="true"></i> 선택복사</button></span></li>
			<li><span class="jbutton large black"><button type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value"><i class="fa fa-arrows" aria-hidden="true"></i> 선택이동</button></span></li>
        </ul>
        <?php } ?>
