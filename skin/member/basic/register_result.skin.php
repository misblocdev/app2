...
<div id="reg_result" class="register">
    ...
    <p class="result_txt">
        회원님의 비밀번호는 아무도 알 수 없는 암호화 코드로 <br class="show768"/>저장되므로 안심하셔도 좋습니다.<br>
        아이디, 비밀번호 분실시에는 회원가입시 입력하신 <br class="show768"/>이메일 주소를 이용하여 찾을 수 있습니다.
    </p>

    <p class="result_txt">
        회원 탈퇴는 언제든지 가능하며 일정기간이 지난 후, <br class="show768"/>회원님의 정보는 삭제하고 있습니다.<br>
        감사합니다.
    </p>
