...
.sc_alert {font-size: 3.1250vw;margin-bottom: 2.6042vw;}
#map {padding-top: 80vw;}

.wrap {font-size: 1.5625vw;}
.wrap .info {min-width: 32.5521vw;border-radius: 0.6510vw;}
.wrap .info:nth-child(1) {border: 0;box-shadow: 0.0000vw 0.1302vw 0.2604vw #888;}
.info .title {padding: 0.6510vw 0 0 1.3021vw;height: 4.4271vw;font-size: 2.3438vw;}
.info .close {top: 1.3021vw;right: 1.3021vw;width: 2.2135vw;height: 2.2135vw;background: url('https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/overlay_close.png');background-size: 2.2135vw;}
.info .desc {margin: 1.6927vw 1.3021vw 0 1.3021vw;padding-bottom: 1.9531vw;}
.desc .jibun {font-size: 1.4323vw;margin-top: -0.2604vw;}
.info .img {top: 0.7813vw;left: 0.6510vw;width: 9.5052vw;height: 9.2448vw;}

}
</style>

<?php
$sql_den = ' select * from g5_write_dental ';
